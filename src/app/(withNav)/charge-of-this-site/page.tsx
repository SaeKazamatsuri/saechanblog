    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-12">
            <section className="text-center mb-16">
                <h1 className="text-4xl font-bold tracking-tight">サイト運営者について</h1>
            </section>
            ...
            <section className="bg-white shadow-lg rounded-lg p-8 md:flex md:items-center">
                <div className="flex-shrink-0 mx-auto md:mx-0 md:mr-8 w-32 h-32 rounded-full overflow-hidden">
                    <img src="/image/kazamatsuri.png" alt="運営者の写真" className="object-cover w-full h-full" />
                </div>
            ...
            <section className="mt-16 text-center">
                <p className="text-gray-700">質問や改善提案があれば、気軽にお問い合わせください。</p>
                <a
                    href="/contact"
