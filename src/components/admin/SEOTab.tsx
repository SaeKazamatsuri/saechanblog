...
export default function SEOTab({
    ...
    return (
        <div className="space-y-6">
            <div>
                <label className="block mb-1 text-sm font-medium text-gray-700">ディスクリプション</label>
                <textarea
                    value={description}
            ...
            <div>
                <label className="block mb-1 text-sm font-medium text-gray-700">タグ</label>
                ...
                {tags.length > 0 && (
                    <ul className="flex flex-wrap gap-2">
                        {tags.map((t) => (
                            ...
                            >
                                <span>{t}</span>
                                <button onClick={() => removeTag(t)} className="ml-1 text-blue-700 hover:text-blue-900">
                                    ×
                                </button>
                            </li>
                        ))}
            ...
            <div>
                <label className="block mb-1 text-sm font-medium text-gray-700">OGP 画像</label>
